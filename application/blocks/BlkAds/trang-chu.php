<div class="block_adsHome width_wrapper ">
	...
	?>
		...
		?>
			<a href="<?php echo $link;?>" target="<?php echo $target;?>">
				<div class="item" style="background: url(<?php echo $picture;?>) no-repeat;width: 200px;height:163px;float:left"> 
				<?php echo '<h2 class="ads_title">'.$name.'</h2>';?>
				</div>
			</a>
