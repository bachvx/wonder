<?php
class Block_BlkDiadiemCategoryLeft extends Zend_View_Helper_Abstract{
	
	public function BlkDiadiemCategoryLeft($template = 'default'){
		$view = $this->view;
		...
		foreach ($result AS $key => $val){
			...
			$link = $view->url($urlOptions,'diadiem-category');
		...
		if($xhtml != ''){
			require_once BLOCK_PATH . '/BlkDiadiemCategoryLeft/'.$template.'.php';
		}
	}
