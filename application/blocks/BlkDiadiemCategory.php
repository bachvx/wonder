<?php
class Block_BlkDiadiemCategory extends Zend_View_Helper_Abstract{
	
	public function BlkDiadiemCategory($template = 'default'){
		$view = $this->view;
		...
		if(!$strMenu = $cache->load('diadiem_category')){
			...
			$cache->save($strMenu,'diadiem_category');
		}

		include(BLOCK_PATH . '/BlkDiadiemCategory/'.$template.'.php');
	}
