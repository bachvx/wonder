<div class="sanpham">
			<div class="container">
				<div class="title2">
					<h2 class="wow tada animated"><a href="" style="text-transform: uppercase;padding: 10px 15px 22px;"><?php echo $view->language['sanphanbanchay']; ?></a></h2>
					<div class="line"></div>
				</div>
			...
			?>
				    ...
				    <script src="http://genex.com.vn/public/templates/public/default/js/slick.js" type="text/javascript" charset="utf-8"></script>
