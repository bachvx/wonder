<div class="width_wrapper dia-diem-cate-home ">
<div class="home2_category">
<div class="home_category_title">
	<h2>Lẩu - nướng - Buffet</h2>
</div>
<?php
	$k=0;
...
<div class="block_diadiemHome fleft <?php echo $key_category; ?> <?php echo $val_category['alias']; ?> block_diadiemHome_<?php echo $key_category+1; ?>">
