...
?>
<div class="block_diadiemHot">
	<div class="block_title clearfix">
		<span class="icon"></span> 
		<h3 class="title"><a href="#" title="Địa điểm hot<?php //echo $view->language['diadiemYeuThich'];?>"><?php //echo $view->language['diadiemYeuThich'];?>Địa điểm Hot</a></h3>
	</div>
