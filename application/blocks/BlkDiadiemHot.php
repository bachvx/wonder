<?php
class Block_BlkDiadiemHot extends Zend_View_Helper_Abstract{

	public function blkDiadiemHot($template = 'default'){
		$view  = $this->view;
		...
		if($flagShow == true){
			...
			*/
			...
			if(count($row) > 0){
				require_once (BLOCK_PATH . '/BlkDiadiemHot/'.$template.'.php');
			}
		}
	}
}