<?php
class Default_Model_Genexhome extends Zend_Db_Table{
	
	protected $_name = 'genex';
...
// 		}
	...
	public function saveItem($arrParam = null, $options = null){
		if($options['task'] == 'admin-add'){
            ...
            $row->picture_vitri		= stripslashes($arrParam['picture_vitri']);
		...
		if($options['task'] == 'admin-edit'){
			...
			$row->mota 			        = $arrParam['mota'];
            $row->mota_en 			    = $arrParam['mota_en'];
            $row->vitri_content              = stripslashes($arrParam['vitri_content']);
            $row->vitri_content_en           = stripslashes($arrParam['vitri_content_en']);
            $row->image_tongquan             = stripslashes($arrParam['image_tongquan']);
            $row->image_solieu               = stripslashes($arrParam['image_solieu']);
            $row->noidung_image_tongquan     = stripslashes($arrParam['noidung_image_tongquan']);
            $row->noidung_image_tongquan_en  = stripslashes($arrParam['noidung_image_tongquan_en']);
            $row->dientich                   = stripslashes($arrParam['dientich']);
            $row->matdo                      = stripslashes($arrParam['matdo']);
            $row->dtcayxanh                  = stripslashes($arrParam['dtcayxanh']);
            $row->dtgiaothong                = stripslashes($arrParam['dtgiaothong']);
            $row->lang_code 		    = $language->lang;
			$row->save();
		}
