<?php
class AdminChuDauTuController extends Zendvn_Controller_Action{
	...
	public function indexAction(){		
		$this->view->Title = 'Genex :: Index';
       
		$this->view->headTitle($this->view->Title, true);
		
		$tblGroup = new Default_Model_Genex();
	...
	public function editAction(){
	   //die("đa");
		$this->view->Title = 'Giới thiệu chủ đầu tư';
		$this->view->headTitle($this->view->Title, true);
		...
		if($this->_request->isPost()){
			...
			if($validator->isError() == true){
               ...
               // die("1");
				...
				$this->_redirect('default/admin-chu-dau-tu/edit/id/5');
			}
		}
	}
	
	public function deleteAction(){
		$this->view->Title = 'Genex :: Xóa';
		$this->view->headTitle($this->view->Title, true);
		if($this->_request->isPost()){
