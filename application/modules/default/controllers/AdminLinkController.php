<?php
class AdminLinkController extends Zendvn_Controller_Action{
	...
	public function indexAction(){
		$this->view->Title = 'Liên kết :: Danh sách';
	...
	public function addAction(){
		...
		if($this->_request->isPost()){
			...
			$validator = new Default_Form_ValidateLink($this->_arrParam);
	...
	public function editAction(){
		...
		if($this->_request->isPost()){
			...
			if($validator->isError() == true){
				...
				$this->_redirect("default/admin-link/edit/id/21");
			}
		}
	}
	
	public function deleteAction(){
		$this->view->Title = 'Liên kết :: Xóa';
		$this->view->headTitle($this->view->Title, true);
		if($this->_request->isPost()){
