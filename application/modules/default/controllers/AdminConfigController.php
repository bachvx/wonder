...
class AdminConfigController extends Zendvn_Controller_Action{
	...
	public function indexAction(){
		...
		if($this->_request->isPost()){
            ...
            $config->config_site->video 	        = $this->_arrParam['config_site_video'];
			$config->config_site->imgads 	        = $this->_arrParam['config_site_imgads'];
            $config->config_site->offImage 	        = $this->_arrParam['config_site_offImage'];
            $config->config_site->files 	        = $this->_arrParam['config_site_file'];
