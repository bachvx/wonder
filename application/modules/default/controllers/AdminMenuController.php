...
class AdminMenuController extends Zendvn_Controller_Action{
	...
	public function quanngonAction(){
		$tblQuanngon = new Quanngon_Model_Category();
		$this->view->slbQuanngon = $tblQuanngon->itemInSelectbox($this->_arrParam);
		$this->view->Item = $this->_arrParam;
		$this->_helper->layout->disableLayout();
	}
	
	public function diadiemAction(){
		$tblDiadiem = new Diadiem_Model_Category();
