<?php
class Default_Form_ValidateDistricts{
	...
	public function __construct($arrParam = array(), $options = null){
		...
		if($arrParam['action'] == 'add'){
			$options = array('table'=>'districts','field'=>'name');
		}else if($arrParam['action'] == 'edit'){
			$clause = ' id !=' . $arrParam['id'];
			$options = array('table'=>'districts','field'=>'name','exclude'=>$clause);
		}
		...
		//KIEM TRA country_id
		//=========================================
		if($arrParam['city_id'] == 0){
			$this->_messagesError['city_id'] = 'Bạn cần chọn quốc gia';
		}
