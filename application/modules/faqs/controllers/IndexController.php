...
class Faqs_IndexController extends Zendvn_Controller_Action {
	...
	public function categoryAction(){
		...
		$this->view->ItemsCategory = $tblFaqs->listItem($this->_arrParam,array('task'=>'public-list-category'));
		$this->view->Items = $tblFaqs->listItem($this->_arrParam,array('task'=>'public-category-new'));
		...
		if($this->_request->isPost()){
			...
			if($validator->isError() == true){
				...
				$tblFaqs->saveItem($this->_arrParam,array('task'=>'public-faqs-add'));
				$this->_redirect('/faqs.html?save=ok');
			}
		}
	}
