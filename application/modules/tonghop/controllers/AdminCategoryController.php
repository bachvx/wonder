<?php
class Quanngon_AdminCategoryController extends Zendvn_Controller_Action{
	...
	public function indexAction(){
		$this->view->Title = 'quán ăn :: Danh mục';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Quanngon_Model_Category();
	...
	public function addAction(){
		$this->view->Title = 'quán ăn :: Danh mục :: Thêm mới';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Quanngon_Model_Category();
		$this->view->slbCategory = $tblCategory->itemInSelectbox($this->_arrParam);
		
		if($this->_request->isPost()){
			$validator = new Quanngon_Form_ValidateCategory($this->_arrParam);
	...
	public function infoAction(){
		$this->view->Title = 'quán ăn :: Danh mục :: Xem thông tin';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Quanngon_Model_Category();
	...
	public function editAction(){
		$this->view->Title = 'quán ăn :: Danh mục :: Sửa';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Quanngon_Model_Category();
	...
	public function deleteAction(){
		$this->view->Title = 'quán ăn :: Danh mục :: Xóa';
		$this->view->headTitle($this->view->Title, true);
		if($this->_request->isPost()){
