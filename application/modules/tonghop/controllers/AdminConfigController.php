<?php
class Quanngon_AdminConfigController extends Zendvn_Controller_Action{
	...
	public function indexAction(){
		$this->view->Title = 'Cấu hình module quán ăn';
		...
		if($this->_request->isPost()){
			...
			$config->module->showAuthor 		= $this->_arrParam['showAuthor'];
			...
			$config->module->showDate	 		= $this->_arrParam['showDate'];
			$config->module->showHits	 		= $this->_arrParam['showHits'];
