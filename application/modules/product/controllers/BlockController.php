<?php
class Product_BlockController extends Zendvn_Controller_Action {
	...
	public function init(){
		...
		$this->loadTemplate($template_path, 'template.ini', 'diadiem_block');
	...
	public function moiAction() {
		...
		$this->view->title = $this->view->language['diadiemMoi'];
		$this->view->headTitle($this->view->title, true);
	
		$this->view->Items = $tblDiadiem->listItem($this->_arrParam,array('task'=>'public-block'));
	
		$totalItem = $tblDiadiem->countItem($this->_arrParam,array('task'=>'public-block'));
	...
	public function banChayAction() {
		...
		$this->view->title = $this->view->language['diadiemDongkhach'];
		$this->view->headTitle($this->view->title, true);
	
		$this->view->Items = $tblDiadiem->listItem($this->_arrParam,array('task'=>'public-block','block' => 'block_dongkhach'));
	
		$totalItem = $tblDiadiem->countItem($this->_arrParam,array('task'=>'public-block','block' => 'block_dongkhach'));
	...
	public function khuyenMaiAction() {
		...
		$this->view->title = $this->view->language['diadiemKhuyenMai'];
		$this->view->headTitle($this->view->title, true);
	
		$this->view->Items = $tblDiadiem->listItem($this->_arrParam,array('task'=>'public-block','block' => 'block_khuyenmai'));
	
		$totalItem = $tblDiadiem->countItem($this->_arrParam,array('task'=>'public-block','block' => 'block_khuyenmai'));
	...
	public function noiBatAction() {
		...
		$this->view->title = $this->view->language['diadiemNoiBat'];
		$this->view->headTitle($this->view->title, true);
	
		$this->view->Items = $tblDiadiem->listItem($this->_arrParam,array('task'=>'public-block','block' => 'block_noibat'));
	
		$totalItem = $tblDiadiem->countItem($this->_arrParam,array('task'=>'public-block','block' => 'block_noibat'));
	...
	public function hotAction() {
		...
		$this->view->title = $this->view->language['diadiemHot'];
		$this->view->headTitle($this->view->title, true);
	
		$this->view->Items = $tblDiadiem->listItem($this->_arrParam,array('task'=>'public-block','block' => 'block_hot'));
	
		$totalItem = $tblDiadiem->countItem($this->_arrParam,array('task'=>'public-block','block' => 'block_hot'));
	...
	public function ajaxAction() {
		...
		$tblDiadiem = new Diadiem_Model_Item();
		$this->view->Items = $tblDiadiem->listItem($this->_arrParam,array('task'=>'public-ajax'));
	}
}
