<?php
class Product_AdminAttributeController extends Zendvn_Controller_Action{
	...
	public function indexAction(){
		...
		$tblAttribute = new Diadiem_Model_Attribute();
	...
	public function addAction(){
		...
		if($this->_request->isPost()){
			$validator = new Diadiem_Form_ValidateAttribute($this->_arrParam);
