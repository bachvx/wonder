<?php
class Product_Model_Bill extends Zend_Db_Table{
	...
	public function getItem($arrParam = null, $options = null){
		...
		if($options['task'] == 'admin-info' || $options['task'] == 'admin-edit'){
			...
			->joinLeft('diadiem AS p', 'id.diadiem_id = p.id',array('p.name AS diadiem_name','p.picture','p.thumb','p.alias','p.units_money','p.cat_id'))
	...
	public function getOther($arrParam = null, $options = null){
		...
		if($options['task'] == 'get-money'){
			$select = $db->select()
			->from('diadiem_money AS pm',array('code','currency'));
			$result = $db->fetchPairs($select);
		}
