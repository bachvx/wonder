<?php
class Product_Model_Attribute extends Zend_Db_Table{
	
	protected $_name = 'diadiem_attribute';
	...
	public function listItem($arrParam = null, $options = null){
		...
		if($options['task'] == 'admin-list'){
			...
			$select = $db->select()
			->from('diadiem_attribute AS pa')
			->joinLeft('diadiem_attribute_category AS pac', 'pac.id = pa.cat_id', array('pac.name AS category_name'));
