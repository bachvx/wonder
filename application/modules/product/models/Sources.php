<?php
class Product_Model_Sources extends Zend_Db_Table{
	
	protected $_name = 'diadiem_sources';
	...
	public function countItem($arrParam = null, $options = null){
		...
		if($options['task'] == 'admin-list'){
			...
			//$db = Zend_Db::factory($adapter, $config);
			$select = $db->select()
			->from('diadiem_sources AS ps', array('COUNT(ps.id) AS totalItem'));
