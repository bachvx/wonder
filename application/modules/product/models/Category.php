<?php
class Product_Model_Category extends Zend_Db_Table{
	
	protected $_name = 'diadiem_category';
	...
	public function listItem($arrParam = null, $options = null){
		...
		//	->from('diadiem_manu AS u',array('*'))
          ...
          if($arrParam['id']==''){
            $select="SELECT  `u`.`name`  AS `page`,`u`.`id`  AS `page_id` FROM `diadiem_manu` as u";
          }else{
