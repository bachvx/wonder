<?php
class Product_Model_AttributeCategory extends Zend_Db_Table{
	
	protected $_name = 'diadiem_attribute_category';
	...
	public function getItem($arrParam = null, $options = null){
		...
		if($options['task'] == 'admin-info' || $options['task'] == 'admin-edit'){
			...
			$select = $db->select()
			->from('diadiem_attribute_category AS pac')
	...
	public function itemInSelectbox($arrParam = null, $options = null){
		...
		if($options == null){
			$select = $db->select()
			->from('diadiem_attribute_category AS pac', array('id','name'))
			->order('pac.order ASC');
	...
	public function countItem($arrParam = null, $options = null){
		...
		if($options['task'] == 'admin-list'){
			...
			//$db = Zend_Db::factory($adapter, $config);
			$select = $db->select()
			->from('diadiem_attribute_category AS pac', array('COUNT(pac.id) AS totalItem'));
	...
	public function deleteItem($arrParam = null, $options = null){
		...
		if($options['task'] == 'admin-delete'){
			...
			->from('diadiem_attribute AS pa', array('COUNT(pa.id) AS totalItem'))
