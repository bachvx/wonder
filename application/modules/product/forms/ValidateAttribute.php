<?php
class Diadiem_Form_ValidateAttribute{
	...
	public function __construct($arrParam = array(), $options = null){
		...
		if(!$validator->isValid($arrParam['name'])){
			...
			$this->_messagesError['name'] = 'Tên thuộc tính: ' . current($message);
			$arrParam['name'] = '';
		}
		...
		if($arrParam['cat_id'] == 0){
			$this->_messagesError['cat_id'] = 'Bạn cần chọn một nhóm thuộc tính';
		}
