<?php
class Article_AdminCategoryController extends Zendvn_Controller_Action{
	...
	public function indexAction(){
		$this->view->Title = 'Bài viết :: Danh mục';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Article_Model_Category();
	...
	public function addAction(){
		$this->view->Title = 'Bài viết :: Danh mục :: Thêm mới';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Article_Model_Category();
		$this->view->slbCategory = $tblCategory->itemInSelectbox($this->_arrParam);
		
		if($this->_request->isPost()){
			$validator = new Article_Form_ValidateCategory($this->_arrParam);
	...
	public function infoAction(){
		$this->view->Title = 'Bài viết :: Danh mục :: Xem thông tin';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Article_Model_Category();
	...
	public function editAction(){
		$this->view->Title = 'Bài viết :: Danh mục :: Sửa';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Article_Model_Category();
        ...
        $this->view->slbPage = $tblCategory->itemInSelectbox($this->_arrParam, array('task'=>'get-sources'));
	...
	public function deleteAction(){
		$this->view->Title = 'Bài viết :: Danh mục :: Xóa';
		$this->view->headTitle($this->view->Title, true);
		if($this->_request->isPost()){
