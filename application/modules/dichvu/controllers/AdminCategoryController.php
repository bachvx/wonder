<?php
class Dichvu_AdminCategoryController extends Zendvn_Controller_Action{
	...
	public function indexAction(){
		...
		$this->view->Title = 'Dịch vụ:: Danh mục';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Dichvu_Model_Category();
	...
	public function addAction(){
		$this->view->Title = 'Dịch vụ:: Danh mục :: Thêm mới';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Dichvu_Model_Category();
		$this->view->slbCategory = $tblCategory->itemInSelectbox($this->_arrParam);
		
		if($this->_request->isPost()){
			$validator = new Dichvu_Form_ValidateCategory($this->_arrParam);
	...
	public function infoAction(){
		$this->view->Title = 'Dịch vụ:: Danh mục :: Xem thông tin';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Dichvu_Model_Category();
	...
	public function editAction(){
		$this->view->Title = 'Dịch vụ:: Danh mục :: Sửa';
		$this->view->headTitle($this->view->Title, true);
		$tblCategory = new Dichvu_Model_Category();
		...
		if($this->_request->isPost()){
			$validator = new Diadiem_Form_ValidateCategory($this->_arrParam);
			if($validator->isError() == true){
				$this->view->messageError = $validator->getMessageError();
				$this->view->Item = $validator->getData();
			}else{
	...
	public function deleteAction(){
		$this->view->Title = 'Dịch vụ:: Danh mục :: Xóa';
		$this->view->headTitle($this->view->Title, true);
		if($this->_request->isPost()){
