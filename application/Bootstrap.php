...
class Bootstrap extends Zend_Application_Bootstrap_Bootstrap {
	...
	protected function _initDb(){
		...
		$dbOption['params']['username'] = 'admin_wondercity';
		$dbOption['params']['password'] = 'VzigQmNbCJ';
		$dbOption['params']['dbname'] = 'admin_wondercity';
	...
	protected function _initConfig(){
        ...
        //define $language = new Zend_Session_Namespace('language');
